...
import type { GlobalLayout } from './GlobalLayout';
import type { System } from './System';
import type { StaffGroup } from './StaffGroup';
import type { Staff } from './Staff';
import type { GlyphRun } from './GlyphRun';
...
export interface LayoutRenderer {
   ...
   * @throws Error if viewport dimensions don't match SVG viewBox
   * 
   * @example
   * ```typescript
