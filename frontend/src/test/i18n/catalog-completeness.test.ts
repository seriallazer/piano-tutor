 ...
 * - Both catalogs must have exactly 398 keys
...
describe('Translation catalog completeness', () => {
  ...
  it('English catalog has exactly 398 keys', () => {
    expect(enKeys).toHaveLength(398);
  });

  it('Spanish catalog has exactly 398 keys', () => {
    expect(esKeys).toHaveLength(398);
  });
